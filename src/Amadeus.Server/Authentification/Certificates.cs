...
namespace Amadeus.Server.Authentification
{
	...
	public static class Certificates
	{
		...
		private static X509Certificate2 _GenerateCertificate(string file, string password)
		{
			...
			certificateGenerator.SetIssuerDN(new X509Name($"C=NL, O=Slt, CN=Toi"));
			certificateGenerator.SetSubjectDN(new X509Name($"C=NL, O=Slt, CN=Toi"));
			...
			store.SetKeyEntry("Amadeus_key", new AsymmetricKeyEntry(subjectKeyPair.Private), new[]
			{
